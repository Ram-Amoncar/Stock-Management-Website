...
<body style="display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; min-height: 95vh;">
  <h1 class="hero glitch layers" data-text="ERROR"><span>ERROR</span></h1>
